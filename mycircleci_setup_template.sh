...
# Add API in the above created file(launch-agent-config.yaml) and change permissions (auth_token : from CircleCI selfhosted runner)
api:
  auth_token: 5bfc872e4fb6e52dd15173b6c72175ce0c90b5542091ccca98ea68222fbc2651e6a86e7d3ce54c16

runner:
  name: self-hosted
  resource_class: "aakash/hatespeechprojrunner"
