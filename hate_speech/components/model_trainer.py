...
class ModelTrainer:
    ...
    def splitting_data(self, csv_path):
        ...
        try: 
            ...
            logging.info("Reading the date")
            
            
            df = pd.read_csv(csv_path, index_col=False)
            
            # Boolean mask for string type values only
            ...
            # Separating the indep and dep variable
            x=df[TWEET]
            y=df[LABEL]
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifacts:
        ...
        try:
            ...
            # Calling the method
            x_train, y_train, x_test, y_test = self.splitting_data(csv_path=self.data_transformation_artifacts.transformed_data_path)
            ...
            # Saving the data (test and train)
